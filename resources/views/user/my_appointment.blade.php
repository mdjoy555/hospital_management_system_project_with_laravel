      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            @auth
            <li class="nav-item">
              <a class="nav-link" stle="background-color: greenyellow; color: white;"
    ...
    <table>
        ...
        @if(count($appoint)>0)
          ...
          <tr style="background-color: black;" align="center">
              ...
              <td><a class="btn btn-danger" href="{{url('cancel_appoint',$appoints->id)}}"
        ...
        @else
          ...
          There is no appointment</td></td></td></tr>
        @endif
    </table>
  </div>
